/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 1a19704c2d5d75d3045d85bcb79dad2f)
...
interface __BaseEnv_CloudflareEnv {
	...
	SpotifyAdsAgent: DurableObjectNamespace<import("./src/index").SpotifyAdsAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SpotifyAdsAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPOTIFY_WRITE_ENABLED" | "REQUIRE_CF_ACCESS" | "OPERATOR_API_KEY" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET" | "SPOTIFY_REFRESH_TOKEN" | "SPOTIFY_AD_ACCOUNT_ID">> {}
}
